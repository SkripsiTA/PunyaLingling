    ...
    <div class="container-fluid mt--6">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <h3 class="mb-0">Data Panitia Desa Adat <?php echo e(Auth::user()->desaadat->desadat_nama); ?></h3>
                                            </div>
                                            <!-- Light table -->
                                            ...
                                            <table class="table align-items-left table-flush">
                                                ...
                                                <?php
                                                    $i = 1;
                                                ?>
                                                <?php $__currentLoopData = $panitiadesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td> <?php echo e($i++); ?> </td>
                                                        <td> <?php echo e($data->kramamipil->cacahkramamipil->penduduk->nama); ?> </td>
                                                        <td> <?php echo e($data->jabatan); ?> </td>
                                                        <td> <?php echo e($data->status_panitia_desa_adat); ?> </td>
                                                        ...
                                                        <td class="text-center">
                                                            <?php if($data->status_panitia_desa_adat == 'aktif'): ?>
                                                                <a href="<?php echo e(route('edit-prajuru-desa-adat', $data->status_panitia_desa_adat)); ?>" class="btn btn-sm btn-flat btn-warning"><i class="fa fa-edit"></i></a>
                                                                <button type="submit" class="btn btn-sm btn-flat btn-danger nonaktif" data-id="<?php echo e($data->status_panitia_desa_adat); ?>"><i class="fa fa-toggle-off"></i></button>
                                                            <?php else: ?>
                                                                <button type="submit" class="btn btn-sm btn-flat btn-success aktif" data-id="<?php echo e($data->status_panitia_desa_adat); ?>"><i class="fa fa-toggle-on"></i></button>
                                                            <?php endif; ?>
                                            ...
                                            <div class="card-footer py-4">
                                                <?php echo e($panitiadesa->links('vendor.pagination.bootstrap-4')); ?>
      ...
      <div class="modal fade" id="formKegiatanPanitia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form action="<?php echo e(route('get-kegiatan-panitia')); ?>" id="myForm" name="myForm" class="form-horizontal" method="POST">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="panitiakegiatan" class="panitia_kegiatan form-control" id="panitiakegiatan" style="height: 100%; display:block;" required>
                                        ...
                                        <?php $__currentLoopData = $kegiatanpanitia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($data->kegiatan_panitia_id); ?>" data-id="<?php echo e($data->kegiatan_panitia_id); ?>" data-nama="<?php echo e($data->panitia); ?>"><?php echo e($data->panitia); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                </div>
                            </div>
    ...
    $(document).ready(function ($) {
        ...
        $('#next').click(function () {
            ...
            if(input.length != ''){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('create-panitia-desa-adat')); ?>",
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/panitia/panitia-desa.blade.php ENDPATH**/ ?>