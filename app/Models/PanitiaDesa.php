...
class PanitiaDesa extends Model
{
    ...
    protected $fillable = [
        'desa_adat_id', 'krama_mipil_id', 'jabatan', 'kegiatan_panitia_id', 'status_panitia_desa_adat', 'tanggal_mulai_menjabat', 'tanggal_akhir_menjabat',
    ];
    ...
    {
        return $this->belongsTo(KegiatanPanitia::class, 'kegiatan_panitia_id', 'kegiatan_panitia_id');
    }
}
